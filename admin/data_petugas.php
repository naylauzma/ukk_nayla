                                    ...
                                    <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    <button type="submit" name="kirim_petugas" class="btn btn-primary">Tambah Data</button>
                                                </div>
                                                </form>

                                                <?php
                                                include '../config/koneksi.php';
                                                if (isset($_POST['kirim_petugas'])) {
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form action="edit_data.php" method="POST">
                                                        ...
                                                        <p>Apakah anda yakin akan menghapus tanggapan <br> <?php echo $data['nama_petugas'] ?></p>
                                                </div>       
                                                <div class="modal-footer">
